...
impl ConcurrencyControlState {
    pub(crate) fn for_config(policy: ConcurrencyControl) -> Self {
        match policy {
            ...
            ConcurrencyControl::TimestampOrdering => {
                Self::TimestampOrdering(TimestampOrdering::default())
            }
        }
    }
    ...
    fn policy(&self) -> &dyn TransactionConcurrencyControl {
        match self {
            ...
            Self::TimestampOrdering(policy) => policy,
        }
    }
    ...
    pub(crate) fn remove_owner_for_granule_for_test(
        ...
        match self {
            ...
            Self::OptimisticValidation(_) | Self::TimestampOrdering(_) => None,
        }
    }
    ...
    pub(crate) fn committed_transactions_for_test(&self) -> Option<BTreeSet<TransactionId>> {
        match self {
            ...
            | Self::WoundWait(_)
            | Self::WaitDie(_)
            | Self::OptimisticValidation(_)
            | Self::TimestampOrdering(_) => None,
        }
    }
